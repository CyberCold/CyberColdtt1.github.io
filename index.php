...
<html lang="en-US">
<head>
<link rel="shortcut icon" href="/img/graphics/landing/one-moment-delivery.png" type="image/png">
<title>One Moment Delivery</title>
<meta charset="utf-8">
<meta name="description" content="OMD is a best delivery company in Latvia.">
...
<body>
<img src="/img/graphics/landing/one-moment-delivery.png" width="1" height="1" alt="preload"/>
<img src="/img/graphics/landing/one-moment-delivery.png" width="1" height="1" alt="Preload"/>
<img src="/img/graphics/landing/one-moment-delivery.png" width="1" height="1" alt="Preload"/>
<img src="/img/graphics/landing/one-moment-delivery.png" width="1" height="1" alt="Preload"/>
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>OMD<br>
							 One Moment Delivery</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								OMD is the best food delivery company in Latvia, we deliver food from any stores or restaurants in Latvia, fast and most importantly cheap<br>
								<br>🚴🏿Order by phone number +371 25 946 914
							</p>
							<div class='landing-btn-container'>
								<div class="build-btn-button">
									...
									<div class="build-tx1-button">
										<span>Best</span>
										<span class="build-tx2-label">:)</span>
									</div>
									</a>
								</div>
							</div>
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/one-moment-delivery.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="discord-con-container">
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<a href="https://discord.gg/fvpHTnehC8" target="_blank">
